# Upload video give information
# --file is the user id, append it to common file storage location
# --title is defined by user (or is defined in project)
# --description can also be defined here 
# --category as a dropdown menu
# --keywords also defined here
# --privacy status ("public", "private", "unlisted") offer list 0, 1, 2
